const delsuQuestions = [
  ...
  {
    question: "The state government appointed a commission of inquiry to carefully and impartially investigate the community's complaints.",
  ...
  {
    question: "He has a big heart but is inept at following a witty conversation.",
  ...
  },
  {
    ...
    options: ["Opposed to it", "Addicted to it", "Attached to it", "Protected against it"],
    answer: "Protected against it",
  ...
  {
    question: "Saddam Hussein's epitaph has been demolished.",
  ...
  {
    question: "Which of the 3d, 4s, 4p, and 4d orbitals has the lowest energy?",
    options: ["3d", "4s", "4p", "4d"],
    answer: "4s",
  ...
  {
    question: "A compound on analysis gave 2.02g of carbon, 0.35g of hydrogen, and 2.69g of oxygen. If the molecular mass is 90, calculate the molecular formula.",
  ...
  },
  {
    ...
    options: ["Bacteriology", "Algology", "Mycology", "Physiology"],
    answer: "Algology",
    explanation: "Algology is the study of algae."
  },
  {
    question: "The tilapia fish uses the _______ fin for balancing:",
    options: ["Anal", "Ventral", "Caudal", "Dorsal"],
    answer: "Anal",
    explanation: "The anal fin helps fish balance."
  },
  {
    question: "The division of fungi in which the sexual phase is unknown is called:",
    options: [
      "Deuteromycotina",
      "Zygomycotina",
      "Ascomycotina",
  ...
  {
    question: "After counting the numbers of peacocks and antelopes in a zoo, there were 90 heads and 500 legs. How many peacocks are there?",
    options: ["70", "-70", "50", "160"],
    answer: "70",
    explanation: "Using heads and legs equations, peacocks = 70."
  },
  {
    question: "A cuboid is a _______.",
